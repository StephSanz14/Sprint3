...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, NavComponent, ButtonComponent, CardComponent, CardsContainerComponent, FooterComponent],
  templateUrl: './app.component.html',
  styleUrl: './app.component.css'
})
 
/* Esta clase es padre del componente cards-container */
export class AppComponent {
  ...
  //vamos a emitir la variable de arreglo y el string con el tipo de despliegue
  @Input () productsHome: any[]=[];
  @Input () typeChangeHome:string='';
  
  title = 'pruebasSprint3';

  ngOnInit(): void {
    this.fnassign('list'); /* ngOnInit() es útil cuando necesitas realizar configuraciones iniciales en tu componente, especialmente si esas configuraciones dependen de datos o propiedades inicializadas en el ciclo de vida del componente. */
  }

  fnassign(selected:string){
      this.typeChangeHome= selected;
      this.productsHome=this.products; 
  }
